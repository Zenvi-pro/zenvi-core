        ...
        if old_thread is not None and old_thread.isRunning():
            ...
            if not old_thread.wait(1500):
                try:
                    ...
                    pass
        restore = None
        if backend in (BACKEND_CLAUDE, BACKEND_CODEX, BACKEND_HERMES):
            try:
        ...
        def run():
            try:
                ...
                status = {
                    ...
                    BACKEND_HERMES: detect_cli("hermes"),
                }
                QMetaObject.invokeMethod(
                    self,
                    "_on_cli_status",
    ...
    def _connect_cli(self, backend_id: str):
        ...
        def run():
            ...
            try:
                ...
                elif backend_id == BACKEND_HERMES:
                    from windows.agent_runners import register_hermes
                    ok, message = register_hermes(srv.port, srv.token)
            except Exception as e:
